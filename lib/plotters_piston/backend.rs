...
fn make_piston_rgba(color: &BackendColor) -> [f32; 4] {
    ...
    [r as f32 / 255.0, g as f32 / 255.0, b as f32 / 255.0, a as f32]
}
...
impl<'a, 'b> PistonBackend<'a, 'b> {
    pub fn new(
        ...
        Self { size, context, graphics, scale }
    }
}
...
pub fn draw_piston_window<
    F: FnOnce(PistonBackend) -> Result<(), Box<dyn std::error::Error>>,
>(
