...
pub enum Dynamic {
    ...
    SuccessDrivenGaussDistrStdDeviation(f32, f32, f32),
    ...
    > for Dynamic
{
    fn setup(
        ...
        match self {
            Dynamic::SuccessDrivenGaussDistrStdDeviation(
                target_success_rate,
                _k,
                def_std_deviation,
            ) => {
                ...
                context.gauss_sd = *def_std_deviation;
    ...
    fn exec(
        ...
        match self {
            Dynamic::SuccessDrivenGaussDistrStdDeviation(
                ...
                success_driven_gauss_distr_std_deviation(
                    rtd,
                    context,
                    *target_success_rate,
                    *k,
...
fn success_driven_gauss_distr_std_deviation(
    rtd: &RuntimeData<
        Cost,
        Context,
        Chromosome,
    ...
    {
        rerun_logger
            .log_mutation_std_deviation(rtd.generation, context.gauss_sd);
    };
}
